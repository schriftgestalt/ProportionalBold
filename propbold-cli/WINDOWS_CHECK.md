# Re-verify propbold 0.2.0 on Windows 11 (PowerShell, ~10 minutes)
    ...
    propbold .\NotoSansCJKtc-Regular.otf --ratio 1.45                  # expect: 65535 glyphs (… measured, … with fallback stem, 0 failed), ~5–6 min
